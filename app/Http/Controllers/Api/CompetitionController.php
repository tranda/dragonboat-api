...
class CompetitionController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $comp = Competition::create($request->only(['name', 'year', 'location', 'is_active', 'is_locked', 'gender_policy', 'reserves', 'younger_allowance', 'helm_any_gender']));
    ...
    public function update(Request $request, $id) {
        ...
        $comp->update($request->only(['name', 'year', 'location', 'is_active', 'is_locked', 'gender_policy', 'reserves', 'younger_allowance', 'helm_any_gender']));
        return response()->json($comp);
    }
