...
class InitController extends Controller {
    public function index(Request $request) {
        ...
        $races = Race::all()->map(fn($r) => ['id' => $r->id, 'name' => $r->name, 'boatType' => $r->boat_type, 'numRows' => $r->num_rows, 'distance' => $r->distance, 'genderCategory' => $r->gender_category, 'ageCategory' => $r->age_category, 'category' => $r->category]);
        $layouts = [];
